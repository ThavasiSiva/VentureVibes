...
function Malls() {
    ...
    const fetchItems = async () => {
      try {
        ...
        const filteredItems = response.data.filter(
          (item) =>
            item.category_name &&
            item.category_name.category_name === "Malls"
        );
  ...
  return (
    ...
    <div >
      <Container fluid>
        <h1  style={{ textAlign: "center", fontFamily:"serif",color:"rgb(136, 78, 78)", }}>Malls</h1>
        <hr />
        <Row>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <IoLogoYoutube
          onClick={() => handleShow1(item.youtube_url)}
    ...
    <tr>
      ...
      <td>
        <Button variant="success" onClick={() => handleShow(item._id)}>
          Submit
        </Button>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <Button variant="danger" onClick={() => handleShowReviews(item.review)}>
          See Reviews
        </Button>
      </td>
    </tr>
