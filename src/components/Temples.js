...
function Temples() {
    ...
    const fetchItems = async () => {
      try {
        ...
        const filteredItems = response.data.filter(
          (item) =>
            item.category_name && item.category_name.category_name === "Temples"
        );
  ...
  return (
    ...
    <div >
    <Container fluid>
      <h1  style={{ textAlign: "center", fontFamily:"serif",color:"rgb(136, 78, 78)" }}>Temples</h1>
      <hr  />
      <Row>
  ...
  <tbody>
    <tr>
      <th>Timing</th>
      <td><span className="text-primary">{item.timing}</span></td>
    </tr>
    <tr>
      <th>Distance</th>
      <td><span className="text-danger">{item.Distance}</span></td>
    </tr>
    <tr>
      <th>Location</th>
      <td>
